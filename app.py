...
with st.sidebar:
    ...
    components.html("""<div style="background:#f8f9fa; padding:15px; border-radius:12px; border:1px solid #ddd; font-family:sans-serif;">
    <p style="font-weight:bold; margin:0 0 5px 0;">🧮 Hesap Makinesi</p>
    <input type="text" id="scr" style="width:100%; padding:5px; border-radius:4px; margin-bottom:5px;" value="0">
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:5px;"><button onclick="document.getElementById('scr').value=eval(document.getElementById('scr').value)" style="background:#28a745; color:white; border:none; padding:5px; border-radius:4px;">=</button><button onclick="document.getElementById('scr').value=''" style="background:#dc3545; color:white; border:none; padding:5px; border-radius:4px;">C</button></div>
    <p style="font-weight:bold; margin:10px 0 5px 0;">🔐 Şifre Üretici</p>
    <input type="text" id="pass" style="width:100%; padding:5px; border-radius:4px; margin-bottom:5px;" readonly>
