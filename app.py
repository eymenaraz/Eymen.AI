...
st.set_page_config(page_title="Sadece EAY KRAL", page_icon="🧠", layout="centered")
...
st.markdown(f"""
    <div class="header-box">
        ...
        <h2 style="margin: 0;">Sadece EAY KRAL</h2>
    </div>
""", unsafe_allow_html=True)

# --- SİSTEM TALİMATI ---
SYS_INST = """Sen Sadece EAY KRAL'sın. Dünyanın en zeki asistanısın. 
...
if prompt := st.chat_input("Sadece EAY KRAL'a birşeyler sor)"):
    ...
    with st.chat_message("assistant", avatar=BOT_AVATAR):
        with st.spinner("Sadece EAY KRAL düşünüyor 💭..."):
